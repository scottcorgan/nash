...
var Cli = exports.Cli = function (options) {
  ...
  // TODO: test that we set up all items as async
  // - commands
  // - flags
  // - wrappers
  // if (this.options.async) {
  //   this.internals.commands.async();
  //   this.internals.beforeAlls.async();
  //   this.internals.afterAlls.async();
  //   this.internals.flags.async();
  // }
