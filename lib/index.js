...
Cli.prototype.command = function () {
  ...
  // TODO: this test doesn't pass for not overwriting commands
  // because of how we currently find commands. We need to find
  // the command by any of its names. RIght now it needs to match
  // all of its names because it uses _.contains() under the hood.
  // (see Command.prototype.matchesName and Cli.prototype.findCommand);
